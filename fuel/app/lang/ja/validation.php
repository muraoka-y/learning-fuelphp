...
return array(
		...
		'valid_emails'  =>'The field :label must contain a list of valid email address:',
		'valid_url'  	=>'The field :label must contain a valid URL:',
		'valid_ip'  	=>'The field :label must contain a valid IP address',
		'numeric_min'  	=>'The minimum numetric value of :label must be :param:1',
		'numeric_max'  	=>'The maximum numetric value of :label must be :param:1',
